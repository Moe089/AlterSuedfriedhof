...
"nummulitenkalk": {
  ...
  hinweis: "<p style='text-align: justify;'>Die Bezeichnung 'Enzenauer Marmor' ist handelsüblich aber petrographisch nicht korrekt - es handelt sich um nicht metamorphen Sedimentkalk. Die Nummuliten („Münzsteine“) waren im 19. Jahrhundert begehrte Sammlerobjekte.</p>"
},
    /*"rillenkarren": {
...
"carrara-marmor": {
  ...
  beschreibung: "<br><p style='text-align: justify;'><strong>Petrographie & Entstehung</strong><br>Der Carrara-Marmor ist ein weißgrauer, feinkörniger Naturstein mit einer mittleren Korngröße von etwa 0,5 mm. Graphitanreicherungen durchziehen das Gestein in Form von grauen Adern, Punkten und wolkenartigen Strukturen. Aufgrund seiner Homogenität und dichten Kristallstruktur lässt sich der Marmor sehr gut polieren. In der polierten Oberfläche können kleine kraterartige Poren (Tarolli) sowie offene Gasblasen auftreten, die sich durch die gesamte Steinstruktur ziehen. Auch feine, natürliche Verwerfungsrisse gehören zum typischen Erscheinungsbild. In den Apuanischen Alpen rund um Carrara wird der Marmor in über 1000 Steinbrüchen gewonnen, wobei verschiedene Varietäten mit unterschiedlichen Helligkeitsgraden und Strukturen abgebaut werden. Der Carrara-Marmor entstand durch die Metamorphose von Kalkstein, der organische Bestandteile wie abgestorbene Tiere und Pflanzenreste enthielt. Tektonische Bewegungen der Erdkruste führten dazu, dass das Kalksteinmassiv in größere Tiefen gelangte und dort über Jahrmillionen hinweg unter hohem Druck und hohen Temperaturen zu Marmor umkristallisiert wurde.</p><br><p style='text-align: justify;'><strong>Geschichte & Abbau</strong><br>Bereits seit der Römerzeit (ab 1. Jh. v. Chr.) kontinuierlich abgebaut, wurde Carrara-Marmor zum Inbegriff des Statuenmarmors (Michelangelos David). Die Steinbrüche in den Apuanischen Alpen liefern noch heute weltberühmtes Material. Im Vergleich zu anderen weißen Marmoren (z.B. Laas-Marmor) ist Carrara-Marmor besonders feinkörnig und homogen.</p><br><p style='text-align: justify;'><strong>Verwendung</strong><br>Historisch für Skulpturen, Architektur (Pantheon, Marmorplatten) und repräsentative Bauten. Auf dem Südfriedhof seit dem frühen 19. Jahrhundert für Grabreliefs und Büsten verwendet, mit besonderer Beliebtheit ab 1870. Trotz Friedhofsverordnungen der 1920er Jahre, die rein weiße Steine oft untersagten, blieb der Südfriedhof eine Ausnahme, wo Carrara-Marmor weiterhin verwendet wurde.</p><br><p style='text-align: justify;'><strong>Besonderheiten</strong><br>Der 'Statuario'-Typ mit seiner transluziden Optik gilt als edelste Varietät. Die langjährige Abbautradition macht ihn zum kulturhistorisch bedeutendsten Marmor Europas. Im Gegensatz zu deutschen 'Marmoren' (z.B. Wunsiedel) zeigt er eine echte metamorphe Kristalltextur.</p>",
...
"grauer-granit": {
  ...
  fundort: " Bayerischer Wald  vsl. (Hauzenberger Massiv, Saldenburger Massiv, Prackenbach, Patersdorf, Prünst, Zwiesel, Viechtach u.a.)",
...
"jurakalk-grau": {
  ...
  "hinweis": "<p style='text-align: justify;'>Wichtig: Trotz der Bezeichnung 'Marmor' handelt es sich geologisch um nicht metamorphen Kalkstein. Die verschiedenen Farbvarietäten werden im Handel als 'Jura Gelb', 'Jura Grau' etc. angeboten.</p>"
},
"lithothamnienkalk": {
...
"zoeblitzer-serpentinit": {
  ...
  beschreibung: "<br><p style='text-align: justify;'><strong>Petrographie & Entstehung</strong><br>Der Zöblitzer Serpentinit ist ein besonders widerstandsfähiges Serpentingestein mit charakteristischen roten Granat-Einsprenglingen in grüner Matrix. Seine Entstehung ist für das Erzgebirge einzigartig: Im Präkambrium erstarrten in den tiefsten Bereichen der Erdkruste oder sogar darunter kieselsäurearme, eisenreiche, ultramafische Gesteine, die überwiegend aus Olivin und Granat bestanden. Tektonische Prozesse pressten Teile dieser Gesteine im Raum Zöblitz und Ansprung später in höhere Krustenbereiche, wo sie zwischen kristalline Schiefer eingeschoben wurden. Unter Wasseraufnahme und etwas niedrigeren Temperaturen verwandelte sich das ursprüngliche Gestein durch Metamorphose in Serpentinit. Durch intensive Schieferung, Klüftung und spätere Verwitterung entstanden verschiedene Farbvarianten von hellgrün über grau und gelblich bis hin zu rot. Die charakteristischen Almandin-Granate und die politurfähige, kompakte Matrix machen den Zöblitzer Granatserpentin einzigartig unter deutschen Serpentiniten.</p><br><p style='text-align: justify;'><strong>Abbau & Lagerstätten</strong><br>Gewonnen im historischen Steinbruch bei Zöblitz, der seit dem 16. Jahrhundert bekannt ist. Der Abbau wurde nach 1945 eingestellt, da keine Lieferungen mehr in die Bundesrepublik erfolgten. Die Lagerstätte gehört zum Erzgebirgischen Kristallin.</p><br><p style='text-align: justify;'><strong>Historische Nutzung</strong><br>Am Alten Südfriedhof zeigt der Zöblitzer Granatserpentin eine ungewöhnlich gute Erhaltung - entgegen der literarischen Beschreibung als verwitterungsanfällig. Meist nur leicht angewittert, belegt dies seine besondere Resistenz. Verwendung vor allem für kunstvolle Grabmal-Elemente.</p><br><p style='text-align: justify;'><strong>Besonderheiten</strong><br>Als resistentester Serpentin-Typ Deutschlands widerlegt der Zöblitzer Granatserpentin das Klischee der Verwitterungsanfälligkeit. Seine charakteristische grün-rote Farbskala und politurfähige Oberfläche machten ihn zum begehrten Material für Drechsler und Steinmetze.</p>",
