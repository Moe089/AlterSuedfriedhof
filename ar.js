            ...
            <script>
                ...
                async function initCamera() {
                    try {
                        ...
                        return await tryCameraConstraints({
                            video: {
                                facingMode: 'environment',
                        ...
                        console.warn("Primary camera config failed, trying fallback", firstError);
                        
                        try {
                            // Fallback with less specific requirements
                            return await tryCameraConstraints({
                                video: {
                                    facingMode: 'environment'
                                }
                            ...
                            showError("Kamera konnte nicht gestartet werden. " + 
                                    "Bitte:<br>- HTTPS verwenden<br>- Kamera erlauben<br>" +
                                    "- Andere Kamera-Apps schließen<br>- Gerät neustarten");
                            console.error("Camera initialization failed:", secondError);
                        }
                    }
                }
                
                async function tryCameraConstraints(constraints) {
